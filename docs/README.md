...
| 64 | `superpowers/plans/2026-08-11-evidence-foundation.md` | Four gates and a collector: stop losing survivorship evidence, and close the holes that let a ratified decision ship unimplemented | owner-pending |
