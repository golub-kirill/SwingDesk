...
|---|---|---|---|---|
| **Research governance** | `PREREG_TEMPLATE.md`, `BACKTEST_PROTOCOL.md`, `WALKFORWARD_SPEC.md`, six pre-registrations | `COVERED` | multiple-testing correction named as an open item and not adopted | none — extend `PREREG_TEMPLATE.md` §6 if a correction is chosen |
