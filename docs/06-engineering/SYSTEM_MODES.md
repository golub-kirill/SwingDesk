...
|---|---|---|---|
| `RESEARCH` | **yes** | `tools/run_pr001.py`, `tools/run_pr002.py`, `tools/run_pr005.py`, `tools/run_pr008.py` | four studies reported; each pins its own parameters and reads no registry |
