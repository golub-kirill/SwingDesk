...
| 8 | `pytest` | unit, property and golden-vector tests | **exists** — 298 tests, fully offline |
...
Everything except 10 runs today via `tools/check_gates.py` — **20 gates**. Gates 2 and 3 are
