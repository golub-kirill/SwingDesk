...
SIDE_RECORDS = {
    ...
    "PR-020-power": "no trials: a VARIANCE estimate for PR-020's minimum detectable effect - the "
                    "selected decile held with no stop against its own universe, sized at five "
    ...
    "PR-030-power": "no trials: a VARIANCE estimate for PR-030 - each reading's interval width, "
                    ...
                    "its three",
    "PR-031-power": "no trials: a VARIANCE estimate for PR-031 - each reading's interval width, "
                    "whole and after publication, the verdict estimator's own on the registered "
                    "window and store before registration. Only widths leave it, under the same "
                    "level guard; PR-031 counts its three",
    "PR-032-power": "no trials: a VARIANCE estimate for PR-032 - the basket's and each fund's "
