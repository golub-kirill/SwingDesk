...
| | |
|---|---|
| Merge gates | **26**, one command, all green · **CI since 2026-08-10** (`gates`, windows-latest); 24 run there, 2 report `UNAVAILABLE` because the course PDFs are not in the repo |
