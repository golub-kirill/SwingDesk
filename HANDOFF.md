...
| Tests | **2572**, fully offline |
| Docs | 195 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| Studies | 29 registered · 27 reported |
...
- `claude/intraday-momentum-report`
