...
| Tests | **1186**, fully offline |
| Docs | 136 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| | |
|---|---|
| Journal | 43 runs, 7 incomplete · **20 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 34139 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 3,616,388 rows across 3,750 instruments |
...
- `claude/the-venue-prices-in-pennies`
