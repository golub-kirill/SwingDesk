...
| | |
|---|---|
| Merge gates | **50**, one command: `python tools/check_gates.py` |
| Tests | **1605**, fully offline |
| Docs | 154 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| Studies | 12 registered · 10 reported |
...
*Measured from `data/` on 2026-09-07.*
