...
| Parameters | 101 - 60 `unset`, 37 `assumed`, 4 `owner`, **0 `validated`** |
=======
| Tests | **501**, fully offline |
| Docs | 108 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
| Components | 465 catalogued · 458 registered · 6 `specified` · **1 `active`** |
...
| Track A clock | **5/20** consecutive clean sessions (2026-08-11 to 2026-08-17) · most recent break 2026-08-10 · `a.run_completes`, computed by `tools/track_a_streak.py` |
