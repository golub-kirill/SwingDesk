...
| Tests | **1171**, fully offline |
| Docs | 134 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| | |
|---|---|
| Journal | 39 runs, 7 incomplete · **20 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 29567 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 3,615,267 rows across 3,750 instruments |
...
*Measured from `data/` on 2026-09-02.*
...
- `claude/the-evening-pass-submits`
