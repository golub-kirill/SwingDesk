...
Rewritten 2026-08-08, at the close of phase 1. Read this, then `AGENTS.md`, then `docs/README.md`.
**Everything below was measured from the tree on the day it was written, not remembered.**
...
owner's 116-PDF swing-trading course. **It never places orders** — owner decision D1. The human makes
every trading decision; the system prepares, checks and records them.
...
| Studies | 4 pre-registered, 3 reported — **2 refuted**, 1 accepted and fragile; plus one post-hoc bound |
| Specification coverage | **FULL 30 · PARTIAL 24 · ABSENT 0 · DEFERRED 3** across 57 rows (§0–§56) |
...
- The base strategy measured **+0.028R per trade before costs** and **−0.123R under 3× cost stress**
  (PR-005). Costs are *assumed*, not measured — so the sign of the result sits inside an unvalidated
  number. `PR-006` is registered to replace the weakest of those assumptions.
...
- **Hand-maintained counts drift, every time.** Four have now been caught: the study verdicts
  (`4 studies, 3 refuted` in five documents), the gate total, the specification coverage summary
