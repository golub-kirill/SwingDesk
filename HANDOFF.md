...
| | |
|---|---|
| Journal | 55 runs, 8 incomplete · **22 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 46704 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 3,619,587 rows across 3,750 instruments |
...
- `claude/a-held-leg-is-not-an-open-order`
