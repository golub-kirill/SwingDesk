...
| Tests | **1204**, fully offline |
| Docs | 139 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| | |
|---|---|
| Journal | 49 runs, 8 incomplete · **21 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 39852 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 3,618,452 rows across 3,750 instruments |
...
- `claude/the-tool-missed-a-guard`
