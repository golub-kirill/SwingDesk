...
| Tests | **2078**, fully offline |
| Docs | 169 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
| Components | 465 catalogued · 459 registered · 4 `specified` · **2 `active`** |
| Parameters | 111 - 58 `unset`, 33 `assumed`, 20 `owner`, **0 `validated`** |
| Golden vectors | 25 vectors across 6 components |
| Studies | 18 registered · 16 reported |
