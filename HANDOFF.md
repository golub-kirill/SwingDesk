...
| | |
|---|---|
| Journal | 38 runs, 7 incomplete · **20 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 28419 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 3,613,862 rows across 3,750 instruments |
...
- `claude/sync-fills-closes-the-loop`
