...
| Tests | **2645**, fully offline |
| Docs | 204 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| Studies | 33 registered · 31 reported |
...
- `claude/same-dollar-twice-report`
