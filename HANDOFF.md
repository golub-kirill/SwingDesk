...
| Tests | **2037**, fully offline |
| Docs | 167 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
...
| Studies | 17 registered · 15 reported |
...
- `claude/streak-reads-rotated-logs`
