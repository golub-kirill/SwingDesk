...
| Tests | **1489**, fully offline |
| Docs | 150 files, Tier 0-8 · indexed by `registry/project_manifest.yml` |
| Components | 465 catalogued · 459 registered · 4 `specified` · **2 `active`** |
| Parameters | 109 - 57 `unset`, 33 `assumed`, 19 `owner`, **0 `validated`** |
| Golden vectors | 25 vectors across 6 components |
| Studies | 11 registered · 8 reported |
...
| | |
|---|---|
| Journal | 60 runs, 8 incomplete · **23 run(s) recorded against a dirty tree** and therefore not replayable from their SHA |
| Decisions | 60711 recorded · 0 uncoded refusals (`a.no_uncoded_failures` requires 0) |
| Bar store | 7,488,536 rows across 13,010 instruments |
...
*Measured from `data/` on 2026-09-06.*
